      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2 text-sm text-primary-foreground/90">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-primary-foreground/80">{t('footer.contactCta')}</p>
            <Link to="/contato">
              <Button className="w-full bg-white text-sm font-semibold text-primary hover:bg-white/90">
            ...
            <Link to="/login">
              <Button
                variant="outline"
                className="mt-1 w-full border border-white/60 bg-transparent text-sm text-white transition-colors hover:bg-white hover:text-primary"
              >
                {t('footer.adminPanel')}
              </Button>
            </Link>
        ...
        <div className="mt-10 border-t border-white/20 pt-6 flex items-center justify-between text-xs text-primary-foreground/50">
